        ...
        <div className="footer-content">
          <div className="footer-section">
            ...
            <p className="footer-description">
              FeiとFei
              是一个记录生活点滴，分享恋爱心得的个人网站。我们相信每段关系都有独特的故事和价值。
            </p>
          ...
          <div className="footer-section">
            <h3 className="footer-title">联系</h3>
            <nav className="footer-nav">
              <a
                href="https://github.com/shchnk"
                target="_blank"
              ...
              >
                ...
                <span className="footer-contact-text">GitHub</span>
              </a>
              <a
                href="mailto:doubleshy0n@gmail.com"
                className="footer-contact-link"
              >
                <span className="footer-contact-icon">
                  <svg
              ...
              <a href="tel:+1234567890" className="footer-contact-link">
                ...
                <span className="footer-contact-text">联系电话</span>
              </a>
            </nav>
          </div>
        </div>
